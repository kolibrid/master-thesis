...
In this experiment we evaluate the performance when translating the network. To translate the network around in the scene we use a sine function in the y axis and a constant function in the z axis. For everyframe we update the position of the network creating a wave motion in the z axis direction. We obtain the delta time for every frame during a total of 700 frames (starting from frame number 501 until frame 1200). In Table \ref{tab:experiment_moving} we can see the results obtained in the experiment for all the network sizes and with the averages.
...
\begin{tabular}{llll}
Dataset size & 1\% average low & 0.25\% average low & Average \\
size & 13.418 & 13.418 & 6.505 \\
size/2 & 12.685 & 12.685 & 6.485 \\
size/3 & 13.631 & 13.631 & 6.494 \\
\end{tabular}
