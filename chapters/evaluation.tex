...
We have run some experiments where we analyse the performance of the system. We decided to analyse the parts of the system that can have more impact in the performance and that are most used by the user when exploring the networks. These are: moving the network, scaling the network and selecting nodes (which includes also the cration of relationships in the scene).

In the experiments we will use the profiler from Unity, where we can see a frame chart that contains information about performance data over time on a frame-by-frame basis\footnote{https://docs.unity3d.com/Manual/ProfilerWindow.html}. We will create three tables, one for each experiment. We will run each experiment for three variations of the blood dataset from MIxT. One with a third of the nodes, one with half of the nodes and the final one with all the nodes from the original dataset. We will also remove the relationships for the nodes that doesn't exist anymore from the reduced datasets. It is hard to create a dataset with more nodes because then we would have to add them randomnly.

For this experiments we can show 3 screenshots from the Unity profiler, one for each network size. We can also show 3 tables (or maybe a graph bar?) and show the
...
% \begin{tikzpicture}
% \begin{axis}[
%     title={Average FPS per node selection},
%     xlabel={Node ID},
%     ylabel={Avg. FPS},
%     xmin=0, xmax=20,
%     ymin=0, ymax=180,
...
%     ]
%     coordinates {
%      (1, 86.98678) (2, 127.9083) (3, 118.3348) (4, 114.2518) (5, 129.0339) (6, 110.1637) (7, 136.7278) (8, 148.6127) (9, 131.5426) (10, 136.0563) (11, 157.1314) (12, 160.0461) (13, 137.9729) (14, 128.7614) (15, 139.3922) (16, 138.1177) (17, 132.5768) (18, 157.25) (19, 109.0917) (20, 146.761)
%     };
...
%     ]
%     coordinates {
%      (1, 87.14521) (2, 103.5218) (3, 119.0831) (4, 127.0019) (5, 121.6989) (6, 10) (7, 150.0758) (8, 118.0902) (9, 147.074) (10, 140.6292) (11, 133.9567) (12, 144.7911) (13, 133.8688) (14, 143.0063) (15, 162.0063) (16, 137.2307) (17, 133.7041) (18, 141.3927) (19, 139.1343) (20, 128.9624)
%     };
%     \addlegendentry{Half size}
%
% \end{axis}
%
% \end{tikzpicture}
