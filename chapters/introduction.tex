...
\begin{itemize}
  ...
  \item Performance requirements needed (72 FPS) for the visualization of large biological networks using cheap VR equipment, so that the interactions are not cumbersome.
\end{itemize}
